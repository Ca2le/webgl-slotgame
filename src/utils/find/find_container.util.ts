...
export function findContainer(app: Application<HTMLCanvasElement>, input: string) {
    ...
    const paylineContainer = gameContainer.getChildByName("paylineContainer") as Container<DisplayObject>

    const containers = [gameContainer, maskContainer, shadowContainer, gridContainer, paylineContainer]
